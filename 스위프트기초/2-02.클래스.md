...
- **클래스와 구조체의 차이: 클래스는 참조타입인 반면 구조체는 값타입**
...
//참조타입이라도 불변 인스턴스는 인스턴스 생성 후에 수정할 수 없습니다
//컴파일 오류 발생
//immutableReference.immutableProplerty = 200
